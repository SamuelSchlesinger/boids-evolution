...
/* package boids-evolution-0.1.0.0 */
#define VERSION_boids_evolution "0.1.0.0"
#define MIN_VERSION_boids_evolution(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "boids-evolution-0.1.0.0-IqywTXClv50GJSs8XEU2IY"

#define CURRENT_PACKAGE_KEY "boids-evolution-0.1.0.0-IqywTXClv50GJSs8XEU2IY"
